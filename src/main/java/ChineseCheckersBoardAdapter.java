        ...
        for(int x = 0; x < board.length; x++){
            for(int y = 0; y < board[0].length; y++){
                switch(board[x][y]){
                    ...
                    case 0 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.WHITE, x, y);
                    case 1 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.BLUE, x, y);
                    case 2 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.GREEN, x, y);
                    case 3 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.RED, x, y);
                    case 4 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.BLACK, x, y);
                    case 5 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.YELLOW, x, y);
                    case 6 ->fields[x][y] =new Field(2*radious*y+15,3*radious*x+15,1.5*radious, Color.PURPLE, x, y);
                }
